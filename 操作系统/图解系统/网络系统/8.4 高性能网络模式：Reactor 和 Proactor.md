...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/J0g14CUwaZcvaLVakREneqAvT5K3bknhqFHX6NGc8vfEuBQ3z4kZ9vDdYclYBCBuwsibeGUITiaibSRe6akZOystw/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcvaLVakREneqAvT5K3bknhewrBuH28J9sRn4eGb0tbbTDWh7SoynDQtKwRfwctacVGe5cvkeeh9Q/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcvaLVakREneqAvT5K3bknhiamO3uka4Cp6bPQDUfZ3f4WTFfA7pYEmv6shaDvSEjjAq3Iw5YNriclg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)阻塞 I/O

知道了阻塞 I/O ，来看看**非阻塞 I/O**，非阻塞的 read 请求在数据未准备好的情况下立即返回，可以继续往下执行，此时应用程序不断轮询内核，直到数据准备好，内核将数据拷贝到应用程序缓冲区，`read` 调用才可以获取到结果。过程如下图：

![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcvaLVakREneqAvT5K3bknhUUeVxFG0IxjbFsd9qEXmQoYicpz4yPJR7R5xgv8Fk8sULzImiby4JNUA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)非阻塞 I/O
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcvaLVakREneqAvT5K3bknhBLLs40lrjgwLiczJWIC1EHkUY6Gh2OMw9eF4KKdqcaOicAYpRMG5rVWg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)异步 I/O
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZcvaLVakREneqAvT5K3bknhkg3sEqsaicpUGpMbE5ZKkVGLFLlW9uAkgslmyDBcQb2PLfictWow9LKw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
