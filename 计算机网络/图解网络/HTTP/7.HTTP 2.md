...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSM1MjlvJonq50KZicNI80hlpwoCFEQhxev7c7mTTfpcFmM83N5xU3OSg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGS8ic7HMGcEbgnPm06RiaCU4QEeJvPiciczTj7jW53tJNSxd4oKda3RfZUJw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGShCBic5dbkXJ8Boria8ibq8xa4rI8tcsLZwJcvSiaiaVoJax9mYfx9w2UBQQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

根据 RFC7541 规范，如果头部字段属于静态表范围，并且 Value 是变化，那么它的 HTTP/2 头部前 2 位固定为 `01`，所以整个头部格式如下图：

![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSYarOh3vctxk6K9e9IytjPYnlcEQeO7YRrKJAKyZqGfVZ7QsXkBPDNQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSNaOs3qYiche2wkGFIhFKia3UmoPgUrk2xmIIVnzLRDOKnysVtiaBPMNCA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

通过查表后，字符串 `nghttpx` 的 Huffman 编码在下图看到，共 6 个字节，每一个字符的 Huffman 编码，我用相同的颜色将他们对应起来了，最后的 7 位是补位的。

![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSRL6mAj9YIpzq8r7Ym9KsQgohqBG4nzw2luQRJHy4jwTwvfdGzOFrQQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

最终，`server` 头部的二进制数据对应的静态头部格式如下：

![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSibLRa4ClmuCaG3UvOSQ1vk1Rl51Cux2RS0z8srlwFmITXOUEuc3myIg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSf1wONthD3XE3gjBgYxtVQADZ39PibatyqjZgX2otGKu6EHrvZEWOhuw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSYEIKE8byicmmnVCqUKzh7UQSL69VMyibjPM0RJb9CbBX5cWRaKNSWy0w/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

HTTP/2 把响应报文划分成了两个**帧（\*Frame\*）**，图中的 HEADERS（首部）和 DATA（消息负载） 是帧的类型，也就是说一条 HTTP 响应，划分成了两个帧来传输，并且采用二进制来编码。

HTTP/2 **二进制帧**的结构如下图：

![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSictSOMNnvVI9WiavZC23ibwrYe6icDcbNSdDBFWic8RavLnp7Gic8Y9RsNrw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSlkngqem0eWynVKe82NWxISm69ppw6atlict3qiaVcJ1KsavibeVbVhDDg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSyZWhbQiattsvkePK8gReUEqB2G8wOEWleuz9QlYNhyVumsibSaI71jiaA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSsXH8ibcqibxENYV0K7DIaqqFiaPCibQ89Pib0vmmiaCMvsg3A0DZI89pYfiaQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSuGWMl6ib4EPrBHfeXJDd3kMDqxp4Y6Bm3dD7ibYZXDGdNxGgQGDjFV5w/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/J0g14CUwaZfUsx6kLW0BIhb41MgDMjGSibIe2wVXUPO3Yt4Tv8BTZtmnd3pRTWdV9VGric9fGRd3JJs1fGv8GOfw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
